...
/// </summary>
// Automator-8D61C8D6E256B3C
[OpenSpan.Design.ComponentIdentityAttribute("Automator-8D61C8D6E256B3C")]
...
public sealed class CRM_E_CRMChild_Created : OpenSpan.Automation.Automator
{
	...
	public CRM_E_CRMChild_Created()
	{
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("Automator-8D61C8D6E256B3C");
		// 
		// Set component Ids
		// 
		this.SetId(this.connectableEvent1, new OpenSpan.Design.ComponentIdentity("ConnectableEvent-8D61C8E0654B9B2"));
		this.SetId(this.connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D61C8E10DCE1C5"));
		this.SetId(this.connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D61C8E17E389F9"));
		this.SetId(this.connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D61C8E2E9BE278"));
		this.SetId(this.connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D61C8E3D726534"));
		// 
		...
		this.connectableMethod1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8D6174AB65EC752\\Label-8D6174D3F90E5B0");
		keyinfo2.CloneContextId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8D6174AB65EC752\\MdiChild-8D6174D3F9A2A08");
		...
		this.connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8D6174AB65EC752\\MdiChild-8D6174D3F9A2A08");
		...
		this.connectableMethod2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D61C6F6E989F16\\InteractionManager-8D61C70057F351B");
		keyinfo5.CloneContextId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D61C6F6E989F16\\InteractionManager-8D61C70057F351B");
		...
		// 
		this.CodeDomData = _resources_.GetString("_CRM_E_CRMChild_Created_3_");
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.ConnectableEvent Create_connectableEvent1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableEvent1, new OpenSpan.Design.ComponentIdentity("ConnectableEvent-8D61C8E0654B9B2"));
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D61C8E10DCE1C5"));
		...
		connectableMethod1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8D6174AB65EC752\\Label-8D6174D3F90E5B0");
		OpenSpan.Automation.KeyInfo keyinfo1 = new OpenSpan.Automation.KeyInfo();
		keyinfo1.CloneContextId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8D6174AB65EC752\\MdiChild-8D6174D3F9A2A08");
		keyinfo1.KeyName = "Active";
		keyinfo1.KeyObjectTypeName = null;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D61C8E17E389F9"));
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8D61C8E2E9BE278"));
		...
		connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8D6174AB65EC752\\MdiChild-8D6174D3F9A2A08");
		OpenSpan.Automation.KeyInfo keyinfo1 = new OpenSpan.Automation.KeyInfo();
		keyinfo1.CloneContextId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8D6174AB65EC752\\MdiChild-8D6174D3F9A2A08");
		keyinfo1.KeyName = "Active";
		keyinfo1.KeyObjectTypeName = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8D61C8E3D726534"));
		...
		connectableMethod2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8D61C6F6E989F16\\InteractionManager-8D61C70057F351B");
		OpenSpan.Automation.KeyInfo keyinfo1 = new OpenSpan.Automation.KeyInfo();
