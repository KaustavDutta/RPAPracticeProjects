...
/// </summary>
// WebAdapter-8D6180E6EC660AE
[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE")]
[System.ComponentModel.ToolboxItemAttribute(false)]
public sealed class ACMESearchSystem : OpenSpan.Adapters.Web.WebAdapter
{
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\ActiveXFactory-8D6180F0F574493")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\WinInetFactory-8D6180F0F73CD19")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\MicrosoftHTMLFactory-8D6180F1203C628")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\WebPage-8D6180F1869AFA5")]
	public OpenSpan.Adapters.Web.Controls.WebPage ACMEwpSignIn;
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\Form-8D6180F1863F528")]
	public OpenSpan.Adapters.Web.Controls.Form ACMEfrmCredentials;
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\TextBox-8D6180F185B4F22")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\TextBox-8D6180F1BD38565")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\Button-8D6180F1E34AF00")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\HiddenField-8D6181225AC6ED8")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\WebPage-8D61810F1D768E0")]
	public OpenSpan.Adapters.Web.Controls.WebPage ACMEwpHome;
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\Link-8D61810F1CF3A99")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\WebPage-8D61810F6DA4D01")]
	public OpenSpan.Adapters.Web.Controls.WebPage ACMEwpStores;
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\Form-8D61810F6D6044D")]
	public OpenSpan.Adapters.Web.Controls.Form ACMEfrmSearch;
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\TextBox-8D61810F6D0BD16")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\Button-8D61810F89BF7B5")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\WebPage-8D618110EFFF511")]
	public OpenSpan.Adapters.Web.Controls.WebPage ACMEwpResults;
	
	[OpenSpan.Design.ComponentIdentityAttribute("WebAdapter-8D6180E6EC660AE\\Form-8D618110EFBE71C")]
	public OpenSpan.Adapters.Web.Controls.Form ACMEtblNearestStore;
	...
	public ACMESearchSystem()
	{
		...
		this.ACMEtblNearestStore = new OpenSpan.Adapters.Web.Controls.Form();
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("WebAdapter-8D6180E6EC660AE");
		// 
		// Set component Ids
		// 
		this.SetId(this.ActiveXFactory, new OpenSpan.Design.ComponentIdentity("ActiveXFactory-8D6180F0F574493"));
		this.SetId(this.moduleNameMatchRule1, new OpenSpan.Design.ComponentIdentity("ModuleNameMatchRule-8D6180F0F663078"));
		this.SetId(this.WinInetFactory, new OpenSpan.Design.ComponentIdentity("WinInetFactory-8D6180F0F73CD19"));
		this.SetId(this.moduleNameMatchRule2, new OpenSpan.Design.ComponentIdentity("ModuleNameMatchRule-8D6180F0F7877BA"));
		this.SetId(this.MicrosoftHTMLFactory, new OpenSpan.Design.ComponentIdentity("MicrosoftHTMLFactory-8D6180F1203C628"));
		this.SetId(this.moduleNameMatchRule3, new OpenSpan.Design.ComponentIdentity("ModuleNameMatchRule-8D6180F120A3333"));
		this.SetId(this.ACMEwpSignIn, new OpenSpan.Design.ComponentIdentity("WebPage-8D6180F1869AFA5"));
		this.SetId(this.ACMEfrmCredentials, new OpenSpan.Design.ComponentIdentity("Form-8D6180F1863F528"));
		this.SetId(this.ACMEtxtUserName, new OpenSpan.Design.ComponentIdentity("TextBox-8D6180F185B4F22"));
		this.SetId(this.inputTypeMatchRule1, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D6180F1886ACC2"));
		this.SetId(this.attributeMatchRule1, new OpenSpan.Design.ComponentIdentity("AttributeMatchRule-8D6181A590DB11C"));
		this.SetId(this.ACMEtxtPassword, new OpenSpan.Design.ComponentIdentity("TextBox-8D6180F1BD38565"));
		this.SetId(this.inputTypeMatchRule2, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D6180F1BD9D9B8"));
		this.SetId(this.elementIdMatchRule2, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D6180F1BDE875C"));
		this.SetId(this.ACMEbtnSignin, new OpenSpan.Design.ComponentIdentity("Button-8D6180F1E34AF00"));
		this.SetId(this.inputTypeMatchRule3, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D6180F1E3BDFD7"));
		this.SetId(this.elementIdMatchRule3, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D6180F1E4014E7"));
		this.SetId(this.ACMElblVersion, new OpenSpan.Design.ComponentIdentity("HiddenField-8D6181225AC6ED8"));
		this.SetId(this.inputTypeMatchRule6, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D6181225B31E8F"));
		this.SetId(this.inputNameMatchRule1, new OpenSpan.Design.ComponentIdentity("InputNameMatchRule-8D6181225B75398"));
		this.SetId(this.formActionMatchRule1, new OpenSpan.Design.ComponentIdentity("FormActionMatchRule-8D6180F187DB03F"));
		this.SetId(this.documentUrlMatchRule1, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D6180F18709232"));
		this.SetId(this.documentTitleMatchRule1, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D6180F1875563D"));
		this.SetId(this.ACMEwpHome, new OpenSpan.Design.ComponentIdentity("WebPage-8D61810F1D768E0"));
		this.SetId(this.ACMElnkStores, new OpenSpan.Design.ComponentIdentity("Link-8D61810F1CF3A99"));
		this.SetId(this.innerTextMatchRule1, new OpenSpan.Design.ComponentIdentity("InnerTextMatchRule-8D61810F1FAE8D4"));
		this.SetId(this.documentUrlMatchRule2, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D61810F1DF0F38"));
		this.SetId(this.documentTitleMatchRule2, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D61810F1E2A79F"));
		this.SetId(this.ACMEwpStores, new OpenSpan.Design.ComponentIdentity("WebPage-8D61810F6DA4D01"));
		this.SetId(this.ACMEfrmSearch, new OpenSpan.Design.ComponentIdentity("Form-8D61810F6D6044D"));
		this.SetId(this.ACMEtxtZip, new OpenSpan.Design.ComponentIdentity("TextBox-8D61810F6D0BD16"));
		this.SetId(this.inputTypeMatchRule4, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D61810F6EE597B"));
		this.SetId(this.elementIdMatchRule5, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D61810F6F3EF10"));
		this.SetId(this.ACMEbtnFindStore, new OpenSpan.Design.ComponentIdentity("Button-8D61810F89BF7B5"));
		this.SetId(this.inputTypeMatchRule5, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D61810F8A0C975"));
		this.SetId(this.elementIdMatchRule6, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D61810F8A5AED4"));
		this.SetId(this.elementIdMatchRule4, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D61810F6E8EB0C"));
		this.SetId(this.documentUrlMatchRule3, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D61810F6DE9745"));
		this.SetId(this.documentTitleMatchRule3, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D61810F6E2435D"));
		this.SetId(this.ACMEwpResults, new OpenSpan.Design.ComponentIdentity("WebPage-8D618110EFFF511"));
		this.SetId(this.ACMEtblNearestStore, new OpenSpan.Design.ComponentIdentity("Form-8D618110EFBE71C"));
		this.SetId(this.elementIdMatchRule7, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D618110F0E6A44"));
		this.SetId(this.documentUrlMatchRule4, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D618110F051518"));
		this.SetId(this.documentTitleMatchRule4, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D618110F084B97"));
		// 
		// ACMESearchSystem
		// 
		...
		this.attributeMatchRule1.Text = textmatchdata4;
		...
		this.elementIdMatchRule5.Text = textmatchdata26;
		...
		this.elementIdMatchRule6.Text = textmatchdata27;
		...
		this.elementIdMatchRule4.Text = textmatchdata28;
		...
		// 
		this.documentUrlMatchRule3.Fragment = textmatchdata29;
		textmatchdata30.Text = "training.openspan.com";
		this.documentUrlMatchRule3.Host = textmatchdata30;
		textmatchdata31.Text = "/store_locator";
		this.documentUrlMatchRule3.Path = textmatchdata31;
		this.documentUrlMatchRule3.Port = 80;
		this.documentUrlMatchRule3.Query = textmatchdata32;
		textmatchdata33.Text = "http";
		this.documentUrlMatchRule3.Scheme = textmatchdata33;
		// 
		// documentTitleMatchRule3
		// 
		textmatchdata34.Text = "Stores | Pega Studio Training Web Application";
		this.documentTitleMatchRule3.Text = textmatchdata34;
		...
		// ACMEtblNearestStore
		// 
		this.ACMEtblNearestStore.ElementId = "form1";
		...
		// elementIdMatchRule7
		// 
		textmatchdata35.Text = "form1";
		this.elementIdMatchRule7.Text = textmatchdata35;
		this.ACMEtblNearestStore.MatchRules.Add(this.elementIdMatchRule7);
		this.ACMEtblNearestStore.Name = "ACMEtblNearestStore";
		this.ACMEtblNearestStore.TagName = "FORM";
		this.ACMEtblNearestStore.TargetTypeString = "OpenSpan.Adapters.Web.HtmlFormElement, OpenSpan.Adapters.Web";
		this.ACMEtblNearestStore.UseElementId = true;
		this.ACMEwpResults.Controls.Add(this.ACMEtblNearestStore);
		...
		// 
		this.documentUrlMatchRule4.Fragment = textmatchdata36;
		textmatchdata37.Text = "training.openspan.com";
		this.documentUrlMatchRule4.Host = textmatchdata37;
		textmatchdata38.Text = "/store/locator_result";
		this.documentUrlMatchRule4.Path = textmatchdata38;
		this.documentUrlMatchRule4.Port = 80;
		this.documentUrlMatchRule4.Query = textmatchdata39;
		textmatchdata40.Text = "http";
		this.documentUrlMatchRule4.Scheme = textmatchdata40;
		// 
		// documentTitleMatchRule4
		// 
		textmatchdata41.Text = "Store Locator | Pega Studio Training Web Application";
		this.documentTitleMatchRule4.Text = textmatchdata41;
	...
	internal OpenSpan.Adapters.ActiveX.ActiveXFactory Create_ActiveXFactory(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(ActiveXFactory, new OpenSpan.Design.ComponentIdentity("ActiveXFactory-8D6180F0F574493"));
		...
		// Set designComp Ids
		// 
		this.SetId(moduleNameMatchRule1, new OpenSpan.Design.ComponentIdentity("ModuleNameMatchRule-8D6180F0F663078"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Adapters.WinInet.WinInetFactory Create_WinInetFactory(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(WinInetFactory, new OpenSpan.Design.ComponentIdentity("WinInetFactory-8D6180F0F73CD19"));
		...
		// Set designComp Ids
		// 
		this.SetId(moduleNameMatchRule2, new OpenSpan.Design.ComponentIdentity("ModuleNameMatchRule-8D6180F0F7877BA"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Adapters.Web.MicrosoftHTMLFactory Create_MicrosoftHTMLFactory(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(MicrosoftHTMLFactory, new OpenSpan.Design.ComponentIdentity("MicrosoftHTMLFactory-8D6180F1203C628"));
		...
		// Set designComp Ids
		// 
		this.SetId(moduleNameMatchRule3, new OpenSpan.Design.ComponentIdentity("ModuleNameMatchRule-8D6180F120A3333"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Adapters.Web.Controls.WebPage Create_ACMEwpSignIn(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(ACMEwpSignIn, new OpenSpan.Design.ComponentIdentity("WebPage-8D6180F1869AFA5"));
		...
		// Set designComp Ids
		// 
		this.SetId(ACMEfrmCredentials, new OpenSpan.Design.ComponentIdentity("Form-8D6180F1863F528"));
		this.SetId(ACMEtxtUserName, new OpenSpan.Design.ComponentIdentity("TextBox-8D6180F185B4F22"));
		this.SetId(inputTypeMatchRule1, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D6180F1886ACC2"));
		this.SetId(attributeMatchRule1, new OpenSpan.Design.ComponentIdentity("AttributeMatchRule-8D6181A590DB11C"));
		this.SetId(ACMEtxtPassword, new OpenSpan.Design.ComponentIdentity("TextBox-8D6180F1BD38565"));
		this.SetId(inputTypeMatchRule2, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D6180F1BD9D9B8"));
		this.SetId(elementIdMatchRule2, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D6180F1BDE875C"));
		this.SetId(ACMEbtnSignin, new OpenSpan.Design.ComponentIdentity("Button-8D6180F1E34AF00"));
		this.SetId(inputTypeMatchRule3, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D6180F1E3BDFD7"));
		this.SetId(elementIdMatchRule3, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D6180F1E4014E7"));
		this.SetId(ACMElblVersion, new OpenSpan.Design.ComponentIdentity("HiddenField-8D6181225AC6ED8"));
		this.SetId(inputTypeMatchRule6, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D6181225B31E8F"));
		this.SetId(inputNameMatchRule1, new OpenSpan.Design.ComponentIdentity("InputNameMatchRule-8D6181225B75398"));
		this.SetId(formActionMatchRule1, new OpenSpan.Design.ComponentIdentity("FormActionMatchRule-8D6180F187DB03F"));
		this.SetId(documentUrlMatchRule1, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D6180F18709232"));
		this.SetId(documentTitleMatchRule1, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D6180F1875563D"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Adapters.Web.Controls.WebPage Create_ACMEwpHome(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(ACMEwpHome, new OpenSpan.Design.ComponentIdentity("WebPage-8D61810F1D768E0"));
		...
		// Set designComp Ids
		// 
		this.SetId(ACMElnkStores, new OpenSpan.Design.ComponentIdentity("Link-8D61810F1CF3A99"));
		this.SetId(innerTextMatchRule1, new OpenSpan.Design.ComponentIdentity("InnerTextMatchRule-8D61810F1FAE8D4"));
		this.SetId(documentUrlMatchRule2, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D61810F1DF0F38"));
		this.SetId(documentTitleMatchRule2, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D61810F1E2A79F"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Adapters.Web.Controls.WebPage Create_ACMEwpStores(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(ACMEwpStores, new OpenSpan.Design.ComponentIdentity("WebPage-8D61810F6DA4D01"));
		...
		// Set designComp Ids
		// 
		this.SetId(ACMEfrmSearch, new OpenSpan.Design.ComponentIdentity("Form-8D61810F6D6044D"));
		this.SetId(ACMEtxtZip, new OpenSpan.Design.ComponentIdentity("TextBox-8D61810F6D0BD16"));
		this.SetId(inputTypeMatchRule4, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D61810F6EE597B"));
		this.SetId(elementIdMatchRule5, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D61810F6F3EF10"));
		this.SetId(ACMEbtnFindStore, new OpenSpan.Design.ComponentIdentity("Button-8D61810F89BF7B5"));
		this.SetId(inputTypeMatchRule5, new OpenSpan.Design.ComponentIdentity("InputTypeMatchRule-8D61810F8A0C975"));
		this.SetId(elementIdMatchRule6, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D61810F8A5AED4"));
		this.SetId(elementIdMatchRule4, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D61810F6E8EB0C"));
		this.SetId(documentUrlMatchRule3, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D61810F6DE9745"));
		this.SetId(documentTitleMatchRule3, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D61810F6E2435D"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Adapters.Web.Controls.WebPage Create_ACMEwpResults(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(ACMEwpResults, new OpenSpan.Design.ComponentIdentity("WebPage-8D618110EFFF511"));
		OpenSpan.Adapters.Web.Controls.Form ACMEtblNearestStore;
		ACMEtblNearestStore = new OpenSpan.Adapters.Web.Controls.Form();
		// 
		// ACMEtblNearestStore
		// 
		ACMEtblNearestStore.ElementId = "form1";
		...
		ACMEtblNearestStore.MatchRules.Add(elementIdMatchRule7);
		ACMEtblNearestStore.Name = "ACMEtblNearestStore";
		ACMEtblNearestStore.TagName = "FORM";
		ACMEtblNearestStore.TargetTypeString = "OpenSpan.Adapters.Web.HtmlFormElement, OpenSpan.Adapters.Web";
		ACMEtblNearestStore.UseElementId = true;
		ACMEwpResults.Controls.Add(ACMEtblNearestStore);
		...
		// 
		OpenSpan.Adapters.TextMatchData textmatchdata2 = new OpenSpan.Adapters.TextMatchData();
		documentUrlMatchRule4.Fragment = textmatchdata2;
		OpenSpan.Adapters.TextMatchData textmatchdata3 = new OpenSpan.Adapters.TextMatchData();
		textmatchdata3.Text = "training.openspan.com";
		documentUrlMatchRule4.Host = textmatchdata3;
		OpenSpan.Adapters.TextMatchData textmatchdata4 = new OpenSpan.Adapters.TextMatchData();
		textmatchdata4.Text = "/store/locator_result";
		documentUrlMatchRule4.Path = textmatchdata4;
		documentUrlMatchRule4.Port = 80;
		OpenSpan.Adapters.TextMatchData textmatchdata5 = new OpenSpan.Adapters.TextMatchData();
		documentUrlMatchRule4.Query = textmatchdata5;
		OpenSpan.Adapters.TextMatchData textmatchdata6 = new OpenSpan.Adapters.TextMatchData();
		textmatchdata6.Text = "http";
		documentUrlMatchRule4.Scheme = textmatchdata6;
		...
		// 
		OpenSpan.Adapters.TextMatchData textmatchdata7 = new OpenSpan.Adapters.TextMatchData();
		textmatchdata7.Text = "Store Locator | Pega Studio Training Web Application";
		documentTitleMatchRule4.Text = textmatchdata7;
		...
		// Set designComp Ids
		// 
		this.SetId(ACMEtblNearestStore, new OpenSpan.Design.ComponentIdentity("Form-8D618110EFBE71C"));
		this.SetId(elementIdMatchRule7, new OpenSpan.Design.ComponentIdentity("ElementIdMatchRule-8D618110F0E6A44"));
		this.SetId(documentUrlMatchRule4, new OpenSpan.Design.ComponentIdentity("DocumentUrlMatchRule-8D618110F051518"));
		this.SetId(documentTitleMatchRule4, new OpenSpan.Design.ComponentIdentity("DocumentTitleMatchRule-8D618110F084B97"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Adapters.Web.Controls.Form Create_ACMEtblNearestStore(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		components = new System.Collections.Generic.List<System.ComponentModel.IComponent>();
		OpenSpan.Adapters.Web.Controls.Form ACMEtblNearestStore = new OpenSpan.Adapters.Web.Controls.Form();
		this.SetId(ACMEtblNearestStore, new OpenSpan.Design.ComponentIdentity("Form-8D618110EFBE71C"));
		ACMEtblNearestStore.ElementId = "form1";
		ACMEtblNearestStore.Extender = null;
		ACMEtblNearestStore.ForwardObjectExplorerEvent = true;
